        ...
        children: [
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(width: double.infinity, height: 4, decoration: BoxDecoration(color: AppColors.white, borderRadius: BorderRadius.circular(2))),
                  const SizedBox(height: AppSpacing.xl),
                  SingleChildScrollView(
                    scrollDirection: Axis.horizontal,
                    child: Row(
                      children: List.generate(4, (index) => 
                        Container(margin: const EdgeInsets.only(left: AppSpacing.md), width: 80, height: 36, decoration: BoxDecoration(color: AppColors.white, borderRadius: BorderRadius.circular(AppRadius.round)))
                      ),
                    ),
                  ),
                  ...
                  Expanded(
                    child: GridView.builder(
                      ...
                      itemCount: 4,
                      itemBuilder: (context, index) => Container(decoration: BoxDecoration(color: AppColors.white, borderRadius: BorderRadius.circular(AppRadius.lg))),
                    ),
                  ),
                ],
              ),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [BoxShadow(color: AppColors.black.withValues(alpha: 0.05), blurRadius: 20, offset: const Offset(0, -5))],
            ),
            child: SafeArea(
              child: Column(
